...
import {Holiday, Office} from '../settings.type';
...
export class OfficeComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this._settingS.getOficina().subscribe(
            (resp) => {
                this._loadService.hide();
                this.dataSource = new MatTableDataSource(resp.oficinas);
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.isLoading = true;
                    return this._settingS.searchOficina(query);
                }),
                map((search) => {
                    this.dataSource = new MatTableDataSource(search.oficinas);
