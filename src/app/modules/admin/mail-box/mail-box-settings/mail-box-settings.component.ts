...
import { MailLabel } from '../mail-box.types';
import { labelColorDefs, labelColors } from '../mail-box.constants';

@Component({
  selector: 'erp-mail-box-settings',
  templateUrl: './mail-box-settings.component.html'
})
