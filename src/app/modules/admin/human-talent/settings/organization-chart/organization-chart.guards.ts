...
import {OrganizationChartItemDetailsComponent} from "./organization-chart-item-details/organization-chart-item-details.component";
@Injectable({
    providedIn: 'root'
})
...
export class CanDeactivateItemDetail implements CanDeactivate<OrganizationChartItemDetailsComponent>
{
    canDeactivate(
