...
import { BobyToolTipComponent } from '../../components/tooltip/tooltip.component';
import { ComponentPortal } from '@angular/cdk/portal';

@Directive({
    selector: '[bobyToolTip]'
})
export class BobyToolTipDirective {
    ...
    show() {
        ...
        if (this._overlayRef && !this._overlayRef.hasAttached()) {
            const tooltipRef: ComponentRef<BobyToolTipComponent> = this._overlayRef.attach(new ComponentPortal(BobyToolTipComponent));
