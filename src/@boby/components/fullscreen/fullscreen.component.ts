...
import { FSDocument, FSDocumentElement } from '@boby/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'boby-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'bobyFullscreen'
})
export class BobyFullscreenComponent implements OnInit
{
