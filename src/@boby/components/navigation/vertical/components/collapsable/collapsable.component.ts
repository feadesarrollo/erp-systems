...
@Component({
    selector       : 'boby-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : bobyAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class BobyVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'boby-vertical-navigation-item-collapsed': this.isCollapsed,
            'boby-vertical-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._bobyVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._bobyVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._bobyVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._bobyVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _isChildrenOf(parent: BobyNavigationItem, item: BobyNavigationItem): boolean
    {
