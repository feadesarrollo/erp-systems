...
import { BobyMockApiReplyCallback } from '@boby/lib/mock-api/mock-api.types';

export class BobyMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: BobyMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: BobyMockApiReplyCallback): void
    {
        // Store the reply
